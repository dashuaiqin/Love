...
private int pointerId;
    ...
    public void setNotification(final HeadsUp headsUp) {
        ...
        if (headsUp.getCustomView() == null) {
            ...
            ImageView ivLarge = (ImageView) defaultView.findViewById(R.id.iv_large);
            ...
            ImageUtils.showImageByLoader(getContext(),headsUp.getLargeIconUrl(),ivLarge, IntegerCons.NONE);
